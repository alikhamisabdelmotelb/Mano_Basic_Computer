module controlUnit ( CLK, T, cout, AC, IR,
	...
	reg ali; //?????/* A wire that store EN or COUT and work as input of E flipflop */
	
	assign In = ~I;
	assign 	r =	D[7] & T[3] &In;

    //DECODER
	Decoder3to8 dec(OPCODE, D[7:0]);
	...
	//DR CONTROL
	DR_Control dr(LoadDR, INRDR, CLRDR, T, D); 
   ...
   //SEQUENCE COUNTER CONTROL
	SC_Control sc(CLRSC, INRSC, T, D, I);	
